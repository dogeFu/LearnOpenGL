...
unsigned int load_texture(const char* path,int color_format) {
...
int main() {
	...
	//着色器程序
	ShaderLoader shaderProgram("../shader/coordinate_system.vs","../shader/coordinate_system.fs");
	...
	texture1 = load_texture("../res/container.jpg", GL_RGB);
	texture2 = load_texture("../res/awesomeface.png", GL_RGBA);
